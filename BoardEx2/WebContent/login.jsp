<%@page import="vo.member.MemberVO"%>
...
<html>
	...
	<body>
		<div id="member">
			<section class="login">
				<form action="${cPath }/member/login.do" method="post">
					<table>
						<tr>
							<td><img src="${cPath }/img/login_ico_id.png" alt="아이디" /></td>
							<td><input type="text" name="id" required placeholder="아이디 입력" autocomplete="off" /></td>
						</tr>
						<tr>
							<td><img src="${cPath }/img/login_ico_pw.png" alt="비밀번호" /></td>
				...
				<div class="info">
					...
					<div><a href="${cPath }/member/terms.do">회원가입</a></div>
				</div>
			</section>
		</div>
	</body>
